    ...
    <nav className="bg-white fixed  w-full z-50 border-b backdrop-blur-2xl   border-gray-300 shadow-sm px-4 md:px-10 py-4 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative z-20">
          ...
          <div
            ref={menuRef}
            className={`absolute right-0 top-12 w-40 bg-white shadow-lg border border-gray-200 rounded-lg p-4 transition-all duration-300 ease-in-out ${showList ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'
              }`}
          >
            {/* Close Icon */}
            <img
